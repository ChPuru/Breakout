...
class Upgrade(pygame.sprite.Sprite):
	def __init__(self,pos,upgrade_type,groups):
		...
		self.image = pygame.image.load(f'breakout\\Breakout-main\\graphics\\upgrades\\{upgrade_type}.png').convert_alpha()
...
class Player(pygame.sprite.Sprite):
	def __init__(self,groups,surfacemaker):
		...
		self.laser_surf = pygame.image.load(
			'breakout\\Breakout-main\\graphics\\other\\laser.png').convert_alpha()
		self.laser_rects = []
...
class Ball(pygame.sprite.Sprite):
	def __init__(self,groups,player,blocks):
		...
		self.image = pygame.image.load(
			'breakout\\Breakout-main\\graphics\\other\\ball.png').convert_alpha()
		...
		self.impact_sound = pygame.mixer.Sound(
			'breakout\\Breakout-main\\sounds\\impact.wav')
		self.impact_sound.set_volume(0.1)

		self.fail_sound = pygame.mixer.Sound(
			'breakout\\Breakout-main\\sounds\\fail.wav')
